...
import org.apache.pekko.actor.{ActorRef, ActorSystem, ActorSystemImpl, Cell, ChildStats, InternalActorRef, Props}
...
class CellWrapper(val underlying: Cell) extends Cell {
  ...
  override private[pekko] def isTerminated = underlying.isTerminated
