...
object HasShardCounters {
  ...
  class Mixin(var hostedEntitiesCounter: AtomicLong, var processedMessagesCounter: AtomicLong)
      extends HasShardCounters {
...
object InitializeShardRegionAdvice {
  ...
  @Advice.OnMethodExit
  @static def exit(
    @Advice.This region: Actor with HasShardingInstruments,
    @Advice.Argument(0) typeName: String
  ): Unit = {
...
object InitializeShardAdvice {
  ...
  @Advice.OnMethodExit
  @static def exit(
    @Advice.This shard: Actor with HasShardingInstruments with HasShardCounters,
    @Advice.Argument(0) typeName: String,
    @Advice.Argument(1) shardID: String
  ): Unit = {
...
object ShardGetOrCreateEntityAdvice {
  ...
  @static def enter(
    @Advice.This shard: Actor with HasShardingInstruments with HasShardCounters,
    @Advice.Argument(0) entityID: String
  ): Unit = {
