...
class BootstrapContextPropagationSpec extends WordSpec with Matchers with ContextTesting with Eventually with OptionValues {

  "the BootstrapContextPropagation" should {
