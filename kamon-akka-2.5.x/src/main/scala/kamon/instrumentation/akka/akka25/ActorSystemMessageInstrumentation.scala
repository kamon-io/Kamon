...
import kamon.instrumentation.akka.akka25.advisor.PointMethodAdvisors
import kamon.instrumentation.akka.akka25.mixin.HasTransientContextMixin
import kanela.agent.api.instrumentation.InstrumentationBuilder

class ActorSystemMessageInstrumentation extends InstrumentationBuilder {
  ...
  /**
    ...
    *
    */
  onSubTypesOf("akka.dispatch.sysmsg.SystemMessage")
  ...
  onType("akka.actor.RepointableActorRef")
    .mixin(classOf[HasTransientContextMixin])
    .advise(method("point"), classOf[PointMethodAdvisors])
}