...
import akka.kamon.akka25.instrumentation.kanela.advisor._
import akka.kamon.akka25.instrumentation.kanela.interceptor.{InvokeAllMethodInterceptor, ReplaceWithMethodInterceptor}
import kamon.akka25.instrumentation.kanela.mixin.ActorInstrumentationMixin
