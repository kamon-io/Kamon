...
object Lookups {
  ...
  /**
    ...
    */
  def plainBoolean(key: String): Lookup[java.lang.Boolean] =
    new Lookup[java.lang.Boolean] {
  ...
  /**
    ...
    */
  def plainLong(key: String): Lookup[java.lang.Long] =
    new Lookup[java.lang.Long] {
