...
class B3SingleSpanCodecSpec extends WordSpecLike with Matchers with OptionValues with SpanBuilding {
  val extendedB3Codec = SpanCodec.B3Single()
  ...
  "The ExtendedB3 SpanContextCodec" should {
    ...
    "extract a RemoteSpan from a TextMap when all fields are set" in {
      ...
      textMap.put("B3", "1234-4321-1-2222")
    ...
    "decode the sampling decision based on the X-B3-Sampled header" in {
      ...
      sampledTextMap.put("B3", "1234-4321-1")

      val notSampledTextMap = TextMap.Default()
      notSampledTextMap.put("B3", "1234-4321-0")

      val noSamplingTextMap = TextMap.Default()
      noSamplingTextMap.put("B3", "1234-4321")
    ...
    "not include the X-B3-Sampled header if the sampling decision is unknown" in {
      ...
      extendedB3Codec.encode(context).get("B3").value shouldBe "1234-4321-1-2222"
