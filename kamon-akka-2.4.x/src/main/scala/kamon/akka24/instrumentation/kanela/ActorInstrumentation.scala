...
import akka.kamon.akka24.instrumentation.kanela.advisor._
import akka.kamon.akka24.instrumentation.kanela.interceptor.{InvokeAllMethodInterceptor, ReplaceWithMethodInterceptor}
import kamon.akka24.instrumentation.kanela.mixin.ActorInstrumentationMixin
